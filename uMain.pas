...
begin
  ...
  if (msg.LParamHi=$51) and (msg.LParamLo=MOD_CONTROL) then  //全屏    VK_F12
  begin
    rct.Left:=0;
    rct.Top:=0;
  ...
  if (msg.LParamHi=$57) and (msg.LParamLo=MOD_CONTROL) then  //当前活动窗口  VK_F11
  begin
...
var
  ext:string;
begin
  //save1.Filter:= 'BMP文件(*.bmp)|*.bmp;JPG文件(*.jpg)|*.jpg';  //设置保存文件的扩展名
